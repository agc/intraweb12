<div style="width:200px;height:300px;background-color:#FFFFFF;padding:10px;">

                      <ul id="example2">
                          <li>
                              <a class="slider" href="#">Departamentos</a>
                              <ul>
                                  <li>
                                  <div class="dentroslider" ><a  href="www.elpais">Matemática</a></div>
                                  <div class="dentroslider" > <a class="dentroenslider" href="www.elpais">Matemática</a></div  >
