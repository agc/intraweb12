...
//la descripción se ha definido en el archivo que se carga antes que este , en es.php
...
$GLOBALS["used_mime_types"]=array(
    ...
    "ppt"   => array($GLOBALS["mimes"]["ppt"],"file.gif","\.ppt$"),
	"pps"   => array($GLOBALS["mimes"]["ppt"],"file.gif","\.pps$")  
);
//------------------------------------------------------------------------------
?>
